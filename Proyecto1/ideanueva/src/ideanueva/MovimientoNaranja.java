                ...
                switch (numero) {
                    case 1:
                        ...
                        if (comprobarfin()) {
                            ...
                            tablero.personaje.pospery = ((tablero.tam / 2)) + 1;
                            tablero.personaje.posperx = ((tablero.tam) / 2) + 1;
                            tablero.vecLo[((tablero.tam) / 2) + 1][((tablero.tam) / 2) + 1] = 1;
                            tablero.repintar();
                        } else {
                            try {
                                //mover una posicion
                ...
                switch (numero) {
                    case 1:
                        ...
                        if (comprobarfin()) {
                            ...
                            tablero.vecLo[tablero.tam - 1][tablero.tam - 1] = 0;
                            tablero.vecG[tablero.tam - 1][tablero.tam - 1].setIcon(null);
                            tablero.barbaro2.posX = ((tablero.tam) / 2) + 1;
                            tablero.barbaro2.posY = ((tablero.tam) / 2) + 1;
                            tablero.vecLo[((tablero.tam) / 2) + 1][((tablero.tam) / 2) + 1] = 4;
                            tablero.repintar();
                        } else {
                            try {
                                //mover una posicion
                ...
                switch (numero) {
                    case 1:
                        ...
                        if (comprobarfin()) {
                            ...
                            tablero.vecLo[tablero.tam - 1][tablero.tam - 1] = 0;
                            tablero.vecG[tablero.tam - 1][tablero.tam - 1].setIcon(null);
                            tablero.mago1.posMagoX = ((tablero.tam) / 2) + 1;
                            tablero.mago1.posMagoY = ((tablero.tam) / 2) + 1;
                            tablero.vecLo[((tablero.tam) / 2) + 1][((tablero.tam) / 2) + 1] = 2;
                            tablero.repintar();
                        } else {
                            try {
                                //mover una posicion
                    ...
                    case 3:
                        ...
                        if (comprobarinicio()) {
                            cantidad = 0;
                            tablero.vecLo[tablero.mago1.posMagoX][0] = 0;
                            tablero.vecG[tablero.mago1.posMagoX][0].setIcon(null);
                            tablero.mago1.posMagoY = (tablero.tam / 2) + 1;
                            tablero.mago1.posMagoX = ((tablero.tam) / 2) + 1;
                            tablero.vecLo[((tablero.tam) / 2) + 1][((tablero.tam) / 2) + 1] = 2;
                            tablero.repintar();
                ...
                switch (numero) {
                    case 1:
                        ...
                        if (comprobarfin()) {
                            ...
                            tablero.vecLo[tablero.tam - 1][tablero.tam - 1] = 0;
                            tablero.vecG[tablero.tam - 1][tablero.tam - 1].setIcon(null);
                            tablero.mago2.posX = ((tablero.tam) / 2) + 1;
                            tablero.mago2.posY = ((tablero.tam) / 2) + 1;
                            tablero.vecLo[((tablero.tam) / 2) + 1][((tablero.tam) / 2) + 1] = 3;
                            tablero.repintar();
                        } else {
                            try {
                                //mover una posicion
                    ...
                    case 3:
                        ...
                        if (comprobarinicio()) {
                            cantidad = 0;
                            tablero.vecLo[tablero.tam - 1][tablero.tam - 1] = 0;
                            tablero.vecG[0][tablero.mago2.posY].setIcon(null);
                            tablero.mago2.posY = (tablero.tam / 2) + 1;
                            tablero.mago2.posX = ((tablero.tam) / 2) + 1;
                            tablero.vecLo[((tablero.tam) / 2) + 1][((tablero.tam) / 2) + 1] = 3;
                            tablero.repintar();
                ...
                switch (numero) {
                    case 1:
                        ...
                        if (comprobarfin()) {
                            ...
                            tablero.vecLo[tablero.tam - 1][tablero.tam - 1] = 0;
                            tablero.vecG[tablero.tam - 1][tablero.tam - 1].setIcon(null);
                            tablero.princesa1.posX = ((tablero.tam) / 2) + 1;
                            tablero.princesa1.posY = ((tablero.tam) / 2) + 1;
                            tablero.vecLo[((tablero.tam) / 2) + 1][((tablero.tam) / 2) + 1] = 5;
                            tablero.repintar();
                        } else {
                            try {
                                //mover una posicion
                ...
                switch (numero) {
                    case 1:
                        ...
                        if (comprobarfin()) {
                            ...
                            tablero.vecLo[tablero.tam - 1][tablero.tam - 1] = 0;
                            tablero.vecG[tablero.tam - 1][tablero.tam - 1].setIcon(null);
                            tablero.princesa2.posX = ((tablero.tam) / 2) + 1;
                            tablero.princesa2.posY = ((tablero.tam) / 2) + 1;
                            tablero.vecLo[((tablero.tam) / 2) + 1][((tablero.tam) / 2) + 1] = 6;
                            tablero.repintar();
                        } else {
                            try {
                                //mover una posicion
